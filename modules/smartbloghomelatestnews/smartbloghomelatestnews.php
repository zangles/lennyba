		...
		public function hookDisplayLeftColumn($params) {			
			if(Module::isInstalled('smartblog') != 1){
                ...
                else
                {
                            ...
                            if (!$this->isCached('left_smartblog_latest_news.tpl', $this->getCacheId())){
                                    $view_data['posts'] = SmartBlogPost::GetPostLatestHome(Configuration::get('smartshowhomepost'));									
                                    $this->smarty->assign( array(
                                              'view_data'     	 => $view_data['posts']
                                    ));
                               }
                            return $this->display(__FILE__, 'views/templates/front/left_smartblog_latest_news.tpl', $this->getCacheId());
                } 
		}
