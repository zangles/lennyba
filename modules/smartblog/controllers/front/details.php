...
class  smartblogDetailsModuleFrontController extends smartblogModuleFrontController
{
	...
	{
           parent::initContent();
		   Hook::exec('actionsbsingle', array('id_post' => doubleval(Tools::getValue('id_post'))));
           $blogcomment = new Blogcomment();
           $SmartBlogPost = new SmartBlogPost();
           $BlogCategory = new BlogCategory();
           $id_post = doubleval(Tools::getValue('id_post'));
           ...
           $title_category = $BlogCategory->getNameCategory($id_cate);
            if (file_exists(_PS_MODULE_DIR_.'smartblog/images/' . doubleval(Tools::getValue('id_post')) . '.jpg') )
                {
                   $post_img =  doubleval(Tools::getValue('id_post'));
                }else{
                    $post_img = 'no';
                }
