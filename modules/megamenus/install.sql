DROP TABLE IF EXISTS `PREFIX_megamenus_group`;
CREATE TABLE `PREFIX_megamenus_group` (
  ...
  `type` enum('product','module','link') COLLATE utf8_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `PREFIX_megamenus_group_lang`;
CREATE TABLE `PREFIX_megamenus_group_lang` (
...
DROP TABLE IF EXISTS `PREFIX_megamenus_menu`;
CREATE TABLE `PREFIX_megamenus_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `PREFIX_megamenus_menu_lang`;
CREATE TABLE `PREFIX_megamenus_menu_lang` (
  `menu_id` int(10) unsigned NOT NULL,
  `id_lang` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `PREFIX_megamenus_menuitem`;
CREATE TABLE `PREFIX_megamenus_menuitem` (
...
DROP TABLE IF EXISTS `PREFIX_megamenus_menuitem_lang`;
CREATE TABLE `PREFIX_megamenus_menuitem_lang` (
...
DROP TABLE IF EXISTS `PREFIX_megamenus_module`;
CREATE TABLE `PREFIX_megamenus_module` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `PREFIX_megamenus_module_lang`;
CREATE TABLE `PREFIX_megamenus_module_lang` (
  `module_id` int(10) unsigned NOT NULL,
  `id_lang` int(10) unsigned NOT NULL,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `PREFIX_megamenus_module_position`;
CREATE TABLE `PREFIX_megamenus_module_position` (
  `module_id` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `PREFIX_megamenus_row`;
CREATE TABLE `PREFIX_megamenus_row` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `module_id` int(10) unsigned NOT NULL,
  `menu_id` int(10) unsigned NOT NULL,
  `width` tinyint(3) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `PREFIX_megamenus_row_lang`;
CREATE TABLE `PREFIX_megamenus_row_lang` (
  `row_id` int(10) unsigned NOT NULL,
  `id_lang` int(10) unsigned NOT NULL,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
