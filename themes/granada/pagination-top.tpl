...
{if isset($p) AND $p}
	...
	{/if}
	<!-- Pagination -->
	<div id="pagination{if isset($paginationId)}_{$paginationId}{/if}" class="pagination pagination-top pages clearfix">
		{if $start!=$stop}
			...
			<ul class="pagination">
				{if $p != 1}
					...
					<li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_previous">
						<a class="previous" {$no_follow_text} href="{$link->goPage($requestPage, $p_previous)}">
				...
				{if $pages_nb > 1 AND $p != $pages_nb}
					...
					<li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="pagination_next">
						<a class="next" {$no_follow_text} href="{$link->goPage($requestPage, $p_next)}">
