...
{capture name=path}
	...
	<li class="active">{l s='Price drop'}</li>
{/capture}
			...
			{if $left_column == true}
				{if $right_column == true}
					...
					<div class="col-md-6 padding-both-larger" id="center_column">
						{include file="./prices-drop-center.tpl" productPerRow='2' itemWidth='6'}
					</div>					
				...
				{else}
					<div class="col-md-9 col-md-push-3 col-sm-8 col-sm-push-4 padding-left-larger">
						{include file="./prices-drop-center.tpl" productPerRow='3' itemWidth='4'}
					</div>
			...
			{else}
				...
				{else}
					<div class="col-xs-12 articles-container" id="center_column">
						{include file="./prices-drop-center.tpl" productPerRow='4' itemWidth='3'}
					</div>					
				{/if}
			{/if}					
		</div>
