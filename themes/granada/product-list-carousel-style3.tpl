...
{if isset($products) && $products}
	<div {if isset($id) && $id} id="{$id}"{/if} data-total="{$products|@count}">
	{foreach from=$products item=product name=products}        
        <ul class="product_list products-grid grid-type-1 grid-type-4 column1{if isset($class) && $class} {$class}{/if}">
            ...
            <div itemscope itemtype="http://schema.org/Product">
                ...
                <div class="product-image-wrapper">
                    ...
                    {if isset($quick_view) && $quick_view}
                      <a class="quick-view sw-product-quickview product-btn" href="javascript:void(0)" data-rel="{$product.link|escape:'html':'UTF-8'}">{l s='Quick view'}</a>
                    {/if}
                </div>
