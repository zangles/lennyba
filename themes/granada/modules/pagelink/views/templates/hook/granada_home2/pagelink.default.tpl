	{if isset($menuContents) && $menuContents|@count >0}
		...
		<div class="user-dropdown dropdown visible-sm visible-xs">
		   <a title="{l s='My Account' mod='pagelink'}" class="dropdown-toggle" data-toggle="dropdown"><span class="header-links-icon icon-account"></span><span class="hidden-xs">{l s='My Account' mod='pagelink'}</span><span class="dropdown-arrow"></span></a>
