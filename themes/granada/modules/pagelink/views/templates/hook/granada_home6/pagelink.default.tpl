...
<div class="{$custom_class}">
		...
		{foreach from=$menuContents item=parent_menu name=parent_menus}
			...
			<div class="currency-dropdown dropdown">
               <a title="Currenct" class="dropdown-toggle" data-toggle="dropdown">
               		<span class="long-name">{$parent_menu.currencies.name}</span>
               		<span class="short-name">{$parent_menu.currencies.iso_code}</span>
			...
			<div class="language-dropdown dropdown">
               <a title="Language" class="dropdown-toggle" data-toggle="dropdown">
               		<span class="long-name">{$lang_name}</span>
               		<span class="short-name">{$lang_iso_code}</span>
               		<span class="caret"></span>
               	</a>
               <ul class="dropdown-menu">
			...
			{else}
			<ul class="header-link top-bar-customer">
               <li>
               		<a class="{$parent_menu.custom_class}" href="{$parent_menu.link}" title="{$parent_menu.name}">
	...
	{else}
		...
		<div class="user-dropdown dropdown visible-sm visible-xs">
		   <a title="My Account" class="dropdown-toggle" data-toggle="dropdown"><span class="header-links-icon icon-account"></span><span class="hidden-xs">{l s='My Account' mod='pagelink'}</span><span class="dropdown-arrow"></span></a>
