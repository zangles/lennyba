...
{assign var='option_tpl' value=OvicLayoutControl::getTemplateFile('blockbestsellers.tpl','blockbestsellers')}
{if  $option_tpl!== null}
...
<div id="best-sellers_block_right" class="block products_block">
	...
	{if $best_sellers && $best_sellers|@count > 0}
		<ul class="block_content products-block products-slider-sidebar">
