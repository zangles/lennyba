...
<!-- Block myaccount module sdfsd -->
<div id="myaccount-footer" class="footer-block">
	<h4 class="footer-title">{l s='My account' mod='blockmyaccountfooter'}</h4>
	<!-- <p class="title_block"><a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}" title="{l s='Manage my customer account' mod='blockmyaccountfooter'}" rel="nofollow">{l s='Our account' mod='blockmyaccountfooter'}</a></p> -->
