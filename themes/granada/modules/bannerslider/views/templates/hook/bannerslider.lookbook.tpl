{assign var='option_tpl' value=OvicLayoutControl::getTemplateFile('bannerslider.lookbook.tpl','bannerslider')}
{if  $option_tpl!== null}
...
{else}
    <div class="{$custom_class}">
    	<div class="sw_section sw_section_full gray-button-container">
            ...
            <div class="full-bg-slider-1 test_3 full-screen-slider">
