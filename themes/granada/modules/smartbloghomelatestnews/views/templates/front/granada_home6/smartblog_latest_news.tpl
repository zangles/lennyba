...
<div class="container">
	<div class="carousel-container">
		<h2 class="carousel-title big text-center">{l s='From the blog' mod='smartbloghomelatestnews'}</h2>
		<div class="row">
			
			{if isset($view_data) AND !empty($view_data)}
			<div class="owl-carousel color2 from-theblog-carousel from-theblog-small center-buttons">
				...
				{foreach from=$view_data item=post}
                    ...
                    <article class="article">
                        ...
                        <a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}" class="readmore second_button_111_hover" role="button">{l s='Read More' mod='smartbloghomelatestnews'}</a>
                     </article>
				{/foreach}
