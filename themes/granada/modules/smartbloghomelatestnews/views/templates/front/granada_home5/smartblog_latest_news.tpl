...
<div class="container">
	<div class="carousel-container">
		<h2 class="carousel-title">{l s='From the blog fdgdf' mod='smartbloghomelatestnews'}</h2>
		<div class="row">
			{if isset($view_data) AND !empty($view_data)}
			<div class="owl-carousel from-theblog-carousel from-theblog-small">
				...
				{foreach from=$view_data item=post}
                    ...
                    <article class="article">
                        ...
                        <p>{$post.short_description|truncate:180:"..."|escape:'htmlall':'UTF-8'}</p>
