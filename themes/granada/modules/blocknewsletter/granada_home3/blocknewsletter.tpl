		...
		<div class="newsletter-content light text-center">	
			...
			<form id="newsletter" action="{$link->getPageLink('index', null, null, null, false, null, true)|escape:'html':'UTF-8'}" method="post">
				...
				<div class="input-group input-group-lg">
					<input type="email" name="email" required class="form-control" value="{if isset($msg) && $msg}{$msg}{elseif isset($value) && $value}{$value}{else}{l s='Enter your e-mail' mod='blocknewsletter'}{/if}"> 
...
<div class="section-btn-container"><a href="#aboutus-section" class="section-btn light btn-prev" title="Previous Section">Previous Section</a> <a href="#footer-top-map" class="section-btn light btn-next" title="Next Section">Next Section</a></div>
