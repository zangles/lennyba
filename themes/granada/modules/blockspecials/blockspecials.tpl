...
{assign var='option_tpl' value=OvicLayoutControl::getTemplateFile('blockspecials.tpl','blockspecials')}
{if  $option_tpl!== null}
    		...
    		<ul>
            	<li class="clearfix">
                	<a class="products-block-image" href="{$special.link|escape:'html':'UTF-8'}">
                        ...
                        src="{$link->getImageLink($special.link_rewrite, $special.id_image, 'cart_default')|escape:'html':'UTF-8'}" 
