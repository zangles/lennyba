...
*}
{assign var='option_tpl' value=OvicLayoutControl::getTemplateFile('blockcms.tpl','blockcms')}
{if  $option_tpl!== null}
...
{else}
    {if $block == 1}
    	...
    	{foreach from=$cms_titles key=cms_key item=cms_title}
    		<section id="informations_block_left_{$cms_key}" class="block informations_block_left">
    			...
    			-->
    			<h4 class="footer-title">{if !empty($cms_title.name)}{$cms_title.name}{else}{$cms_title.category_name}{/if}</h4>
    ...
    {else}
    	...
    	<section class="footer-block col-xs-12" id="block_various_links_footer">
    		<h4 class="footer-title">{l s='Information' mod='blockcms'}</h4>
