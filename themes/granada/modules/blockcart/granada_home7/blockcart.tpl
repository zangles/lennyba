...
{/if}
    	<div class="shopping_cart ">    		
    		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" class="dropdown-toggle second_button_111_hover" data-toggle="dropdown" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
