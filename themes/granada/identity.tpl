...
{capture name=path}
	...
	<li><a href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">{l s='My account'}</a></li>
	<li class="active">{l s='Your personal information'}</li>
{/capture}
			...
			{if $left_column == true}
				{if $right_column == true}
					...
					<div class="col-md-6 padding-both-larger" id="center_column">
						{include file="./identity-center.tpl"}
					</div>					
