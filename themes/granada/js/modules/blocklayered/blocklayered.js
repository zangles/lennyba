	...
	ajaxQuery = $.ajax(
	{
		...
		success: function(result)
		{
			...
			if (result.productList) {
                ...
                // Fix fillter load product(3 columns)
                $('#center_column .product_list').removeClass('column2 column3 column4');
                $('#center_column .product_list').addClass(className);
			}
...
function updateProductUrl()
{
	...
	if (typeof(param_product_url) != 'undefined' && param_product_url != '' && param_product_url !='#') {
		$.each($('ul#center_column .product_list li.ajax_block_product .product_img_link,'+
				'ul#center_column .product_list li.ajax_block_product h5 a,'+
				'ul#center_column .product_list li.ajax_block_product .product_desc a,'+
				'ul#center_column .product_list li.ajax_block_product .lnk_view'), function() {
