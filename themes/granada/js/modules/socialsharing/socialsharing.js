		...
		if (type.length)
		{
			switch(type)
			{
				...
				case 'pinterest':
					...
					break;
				case 'linkedin':
					window.open('https://www.linkedin.com/shareArticle?mini=true&url=' + sharing_url+'&title='+sharing_name+'&summary=&source="', 'sharerlinkedin', 'toolbar=0,status=0,width=660,height=445');
					break;
			}
		}
	});
