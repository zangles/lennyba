	...
	for (i in product_list)
	{
		...
		if (reduction && typeof(initial_price) !== 'undefined')
			if (initial_price !== '' && product_list[i].price_without_quantity_discount > product_list[i].price)
				initial_price_text = '<li class="price-percent-reduction small">'+priceReductionPercent+'%</li><li class="old-price">' + initial_price + '</li>';
		...
		if (priceDisplayMethod !== 0)
		{
			$('#product_price_' + key_for_blockcart).html('<li class="product-price-special price special-price">' + current_price + '</li>' + initial_price_text);
