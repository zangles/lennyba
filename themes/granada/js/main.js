!function(a) {
    ...
    var b = {
        ...
        init: function() {
            if (!this.initialised) {
                this.initialised = !0, this.checkMobile(), this.checkPlaceholder(), this.fullHeight(), this.fullWidth(), this.fullSize(), this.menuHover(), this.stickyMenu(), this.responsiveMenu(), this.responsiveMenuExtra(), this.searchInput(), this.itemSizeFix(), this.hoverItemFix(), this.verticalTabHeightFix(), this.filterColorBg(), this.productCarousel(), this.sideBackground(), this.priceSlider(), this.ratings(), this.collapseArrows(), this.owlCarousels(), this.scrollToTopAnimation(), this.scrollToClass(), this.singlePortfolioToScroll(), this.singlePortfolioAffix(), this.filterScrollBar(), this.selectBox(), this.tooltip(), this.popover(), this.countTo(), this.progressBars(), this.registerKnob(), this.prettyPhoto();
                var a = this;
        ...
        fullWidth: function() {
            var b = a(window).height();
            a(".full-width").each(function() {
                var c = a(this);
                c.css("width", b);                
            })
        },
        fullSize: function() {
            var b = a(window).height(), w=a(window).width();
            a(".full-size").each(function() {
                var c = a(this);
                if (c.hasClass("home-full-height")) {
                    var d = a("#header").height(), e = b - d;
                    c.css({"height":e, "width":w})
                }
                else
                    c.css({"height":b, "width":w})
            })
        },
        stickyMenu: function() {
            if (a(window).width() > 979) {
                var b = this, c = a("#sticky-header");
                if (!b.headerClone) {
        ...
        responsiveMenu: function() {
            var b = a("#header").find(".menu").clone(!0).removeClass("menu clearfix").addClass("responsive-menu"), c = a("#header").find("#responsive-menu-container");
            c.append(b), c.find("li, .col-sm-2, .col-sm-3, .col-sm-4, .col-sm-6, .col-md-2, .col-md-3, .col-md-4, .col-md-6").each(function() {
                ...
                var c = a(this), d = a("#responsive-menu-container");
        ...
        responsiveMenuExtra: function() {
            ...
            if (a("#header").hasClass("header1") && a(window).width() <= 767 && !b.responsiveExtra) {
                var c = a("#responsive-menu-container"), d = a("#header").find(".search-container").clone(!0), e = a("#header").find(".user-dropdown").clone(!0), f = a("#header").find(".cart-dropdown").clone(!0);
                c.prepend(d).append(f, e), b.responsiveExtra = !0
            }
            else {
                if (!(a(window).width() > 767 && b.responsiveExtra))
                    return;
        ...
        itemSizeFix: function() {
            var b = a("#content"), c = b.find(".product");
            c.each(function() {
                var b = a(this);
        ...
        verticalTabFixFunc: function() {
            if (!(a(window).width() <= 767)) {
                var b = a(this), c = b.find(".tab-content"), d = c.outerHeight(), e = b.find(".nav.nav-tabs").find("li"), f = e.length, g = d / f;
                e.find("a").css({
                    height: g + 1,
                    "line-height": g + "px"
                })
        ...
        sideBackground: function() {
            if (a(".sidebg").length && a(window).width() > 767) {
                var b = a(window).width(), c = a("#product-single-container").find(".container").width(), d = (b - c) / 2;
        ...
        collapseArrows: function() {
            a(".panel").each(function() {
                var b = a(this), c = b.find(".accordion-btn"), d = b.find(".accordion-body");
        ...
        owlCarousels: function() {
            ...
            function c(a) {
                var b, c = J.data("owlCarousel").owl.visibleItems, d = a, e = !1;
                for (b in c)
                    d === c[b] && (e = !0);
            ...
            var d = this, e = a(".owl-carousel.products-section-carousel");
        ...
        scrollToAnimation: function(b, c, d) {
            ...
            if (a(e).length)
                var g = a(e), h = c ? g.offset().top + c : g.offset().top;
            else {
        ...
        singlePortfolioAffix: function() {
            a("#slider-thumbs").affix({
                offset: {
                    ...
                    bottom: function() {
                        var b = a(".single-portfolio-media-container").outerHeight(!0), c = a("#content").outerHeight(!0), d = a("#footer").outerHeight(!0), e = c - b + d;
        ...
        filterScrollBar: function() {
            var b = a(".category-filter-list.jscrollpane"), c = function(a) {
                var b = a.height();
        ...
        progressBars: function() {
            ...
            a.fn.waypoint ? a(".progress-animate").waypoint(function() {
                if (a(this).hasClass("circle-progress"))
                    ...
                    var c = a(this), d = a(this).data("width"), e = c.find(".progress-text");
                    c.css({
                        width: d + "%"
                    },
        ...
        isotopeFilter: function() {
            ...
            c.find("a").on("click", function(d) {
                var e = a(this), f = e.attr("data-filter"), g = b.container.data("animationclass"), h = g ? g : "fadeInUp";
        ...
        elementsAnimate: function() {
            var b = this.container.data("animationclass"), c = b ? b : "fadeInUp";
            return this.portfolioElAnimation ? void this.container.find(".animate-item").each(function() {
                var b = a(this), d = b.data("animate-time");
                setTimeout(function() {
    ...
    b.init(), a(window).on("load", function() {
        ...
        var d = a(c.target), e = d.closest(".tab-container");
