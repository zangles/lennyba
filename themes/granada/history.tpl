...
<section id="content" role="main">
	...
	<div class="container" id="center_column">		
		...
		<div class="xs-margin"></div>
		<h2 class="color2">{l s='Order history'}</h2>
		...
		<div class="footer_links clearfix text-center">
			<a class="btn btn-default button button-medium button_111_hover" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
					<span>
						{l s='Back to Your Account'}
					</span>
				</a>
				
				<a class="btn btn-default button button-medium button_111_hover" href="{$base_dir}">
					<span>{l s='Home'}</span>
				</a>
