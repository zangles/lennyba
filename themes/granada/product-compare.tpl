...
{if $comparator_max_item}
	<form method="post" action="{$link->getPageLink('products-comparison')|escape:'html':'UTF-8'}" class="pull-right">
		<button type="submit" class="btn btn-custom-8 btn-compare bt_compare{if isset($paginationId)}_{$paginationId}{/if}" disabled="disabled">
