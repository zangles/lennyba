...
<html lang="{$lang_iso}">
    ...
    {if !isset($content_only) || !$content_only}
        ...
        {if ($page_name != 'category' && $page_name !='best-sales' && $page_name != 'search' && $page_name != 'manufacturer' && $page_name != 'supplier' && $page_name != 'prices-drop' && $page_name != 'new-products') and isset($compared_products)}{addJsDef comparedProductsIds=$compared_products}{/if}
			...
			<div id="sticky-header" class="header5 light boxed-menu" data-fixed="fixed"></div>
    		<div id="header-wrapper">
	    		<header id="header" class="header5 {if $page_name == 'index'} absolute {/if} dark boxed-menu">        
	               <div id="header-clone-wrapper" data-clone="sticky">
	               		{hook h="displayCustomSearch"}
	                  	<div class="container">
	                  		<div class="row">
