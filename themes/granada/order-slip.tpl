...
<section id="content" role="main">
	...
	<div class="container" id="center_column">
		...
		<div class="footer_links clearfix text-center">
				...
				<a class="btn btn-default button button-small button_111_hover" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
					<span>
						<i class="icon-chevron-left"></i> {l s='Back to your account'}
					</span>
				</a>
			
				<a class="btn btn-default button button-small button_111_hover" href="{$base_dir}">
					<span>
