{foreach from=$products item=product name=products}
    ...
    <div class="product product2 ajax_block_product" itemscope itemtype="http://schema.org/Product">
        ...
        <div class="product-price-container text-left" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
        ...
        <h3 class="product-name text-left" itemprop="name">
