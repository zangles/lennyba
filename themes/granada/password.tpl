...
{capture name=path}
	...
	<li><a href="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" title="{l s='Authentication'}" rel="nofollow">{l s='Authentication'}</a></li>
	<li class="active">{l s='Forgot your password'}</li>
{/capture}
			...
			{if $left_column == true}
				{if $right_column == true}
					...
					<div class="col-md-6 padding-both-larger" id="center_column">
						{include file="./password-center.tpl"}
					</div>					
