...
{capture name=path}
	...
	<li class="active">{l s='Suppliers'}</li>
{/capture}
			...
			{if $left_column == true}
				{if $right_column == true}
					...
					<div class="col-md-6 padding-both-larger" id="center_column">
						{include file="./supplier-list-center.tpl" itemPerRow='3' itemWidth='4'}
					</div>					
				...
				{else}
					<div class="col-md-9 col-md-push-3 col-sm-8 col-sm-push-4 padding-left-larger">
						{include file="./supplier-list-center.tpl" itemPerRow='4' itemWidth='3'}
					</div>
