...
{capture name=path}
	...
	<li class="active">{l s='Sitemap'}</li>
{/capture}
		...
		<div class="row">
			<div class="col-sm-6 padding-right-md">
				<div class="sitemap_block box">
		    		<h2 class="color2">{l s='Our offers'}</h2>
		    		<ul>
		    			<li>
		                    <a 
            ...
            <div class="col-sm-6 padding-left-md">
            	<div class="sitemap_block box">
		    		<h2 class="color2">{l s='Your Account'}</h2>
		    		<ul>
		        		{if $is_logged}
		        			<li>
		                        <a 
		...
		<div class="row">
			<div class="col-sm-6 padding-right-md">
				<div class="categTree box">
		            <h2 class="color2">{l s='Categories'}</h2>
		            <div class="tree_top">
