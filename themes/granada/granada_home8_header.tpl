...
<html lang="{$lang_iso}">
	...
	<body{if isset($page_name)} id="{$page_name|escape:'html':'UTF-8'}"{/if} class="index7 {if isset($body_classes) && $body_classes|@count} {implode value=$body_classes separator=' '}{/if}{if $hide_left_column} hide-left-column{/if}{if $hide_right_column} hide-right-column{/if}{if isset($content_only) && $content_only} content_only{/if} lang_{$lang_iso} {$current_dir} content-type wide granada-theme {if $page_name =='index'}index-page{else}orther-page{/if}">
    ...
    {if !isset($content_only) || !$content_only}
        ...
        {if ($page_name != 'category' && $page_name !='best-sales' && $page_name != 'search' && $page_name != 'manufacturer' && $page_name != 'supplier' && $page_name != 'prices-drop' && $page_name != 'new-products') and isset($compared_products)}{addJsDef comparedProductsIds=$compared_products}{/if}
			...
			<div id="sticky-header" class="fullwidth-menu header6" data-fixed="fixed"></div>
    		<header id="header" class="fullwidth-menu header6">
               {*}
               <div id="header-top">
                  ...
                  <div class="row">
                  	...
                  	<div class="col-md-4 clearfix">
                  		<nav>
                              ...
                              <a id="responsive-btn" href="#"><span class="responsive-btn-icon"><span class="responsive-btn-block"></span> <span class="responsive-btn-block"></span> <span class="responsive-btn-block last"></span></span> <span class="responsive-btn-text visible-sm-inline-block visible-xs-inline-block">{l s='Menu'}</span></a>
                              <div id="responsive-menu-container"></div>
                           </div>
                  			{hook h="displayMegamenuRight"}
                  		</nav>
                  	</div>
                  </div>
               </div>
