...
{capture name=path}
	...
	<li><a href="{$link->getPageLink('supplier')|escape:'html':'UTF-8'}" title="{l s='Manufacturers'}">{l s='Manufacturers'}</a></li>	
	<li class="active">{$supplier->name|escape:'html':'UTF-8'}</li>
{/capture}
		...
		<div class="row">			
			<div class="col-sm-12">
				...
				<div id="category-banner" class="content_scene_cat_bg">
		    		<h2 class="color2">{l s='List of products by supplier:'}&nbsp;{$supplier->name|escape:'html':'UTF-8'}</h2>
			...
			{if $left_column == true}
				{if $right_column == true}
					...
					<div class="col-md-6 padding-both-larger" id="center_column">
						{include file="./supplier-center.tpl" productPerRow='2' itemWidth='6'}
					</div>					
				...
				{else}
					<div class="col-md-9 col-md-push-3 col-sm-8 col-sm-push-4 padding-left-larger">
						{include file="./supplier-center.tpl" productPerRow='3' itemWidth='4'}
					</div>
			...
			{else}
				...
				{else}
					<div class="col-xs-12 articles-container" id="center_column">
						{include file="./supplier-center.tpl" productPerRow='4' itemWidth='3'}
					</div>					
				{/if}
			{/if}					
		</div>
