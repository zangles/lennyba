...
<section id="content" role="main">
	...
	<div class="container" id="center_column">
		...
		<h2 class="color2">{l s='My account'}</h1>
			...
			<ul class="footer_links clearfix">
				<li><a class="btn btn-default button button-medium button_111_hover" href="{$base_dir}" title="{l s='Home'}"><span><i class="icon-chevron-left"></i> {l s='Back to Home'}</span></a></li>
			</ul>
